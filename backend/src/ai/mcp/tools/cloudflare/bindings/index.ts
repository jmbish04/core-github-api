...
export const getConfig = async (env: Env): Promise<any> => {
    ...
    return {
        ...
        transport: {
            ...
            headers: {
                "Authorization": `Bearer ${resolved.CLOUDFLARE_WORKER_ADMIN_TOKEN}`
            }
        }
    };
};
 ...
 *
 * All fetchCloudflare calls use the (env, path, options?) signature from @/cloudflare/client.
 */
export const getBindingTools = (env: Env) => {
    return [
        ...
        // -------------------------------------------------------------------------
        {
            ...
            parameters: z.object({}),
            execute: async () => {
                return fetchCloudflare(env, "/accounts");
            },
        },
        ...
        // -------------------------------------------------------------------------
        {
            ...
            parameters: z.object({}),
            execute: async () => {
                return fetchCloudflare(env, "/workers/scripts");
            },
        },
        {
            name: "cf_worker_get",
            ...
            execute: async (args: { scriptName: string }) => {
                return fetchCloudflare(env, `/workers/scripts/${args.scriptName}`);
            },
        },
        ...
        // -------------------------------------------------------------------------
        {
            ...
            parameters: z.object({}),
            execute: async () => {
                return fetchCloudflare(env, "/storage/kv/namespaces");
            },
        },
        {
            name: "cf_kv_create",
        ...
        // -------------------------------------------------------------------------
        {
            ...
            parameters: z.object({}),
            execute: async () => {
                return fetchCloudflare(env, "/d1/database");
            },
        },
        {
            name: "cf_d1_create",
        ...
        },
        {
            ...
            execute: async (args: { databaseId: string; sql: string; params?: string[] }) => {
                return fetchCloudflare(env, `/d1/database/${args.databaseId}/query`, {
                    method: "POST",
        ...
        // -------------------------------------------------------------------------
        {
            ...
            parameters: z.object({}),
            execute: async () => {
                return fetchCloudflare(env, "/r2/buckets");
            },
        },
        {
            name: "cf_r2_create",
        ...
        // -------------------------------------------------------------------------
        {
            ...
            parameters: z.object({}),
            execute: async () => {
                return fetchCloudflare(env, "/hyperdrive/configs");
            },
        },
        {
