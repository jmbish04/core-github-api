...
export async function createBranch(
  ...
  await fetchGitHubJson(url, token, { method: "POST", body: { ref: `refs/heads/${newBranchName}`, sha: baseSha } }).catch((error) => {
...
export async function createOrUpdateFile(
  ...
  await fetchGitHubJson(url, token, { method: "PUT", body }).catch((error) => {
