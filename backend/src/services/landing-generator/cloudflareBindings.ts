import { CloudflareBindingDetail } from "./types";
...
export const CLOUDFLARE_BINDING_MAP: Record<string, CloudflareBindingDetail[]> = {
    'Data Storage & Databases': [
        ...
        },
        {
            ...
            llmsTxtLink: createLlmsTxtLink('durable-objects'), // Verified from source URL pattern
        },
        {
