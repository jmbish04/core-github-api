...
export async function checkGitHubHealth(env: Bindings, runId: string): Promise<HealthResult[]> {
...
async function checkWebhookGaps(env: Bindings) {
...
async function runApiChecks(env: Bindings) {
...
async function verifyWebhooks(env: Bindings, issueNumber: number) {
