/**
 * @file backend/src/routes/api/webhooks/workflows/build-failure-analyzer.ts
 ...
 *              Optimized for automated code agents: encapsulates log gathering, limits context size, and frames instructions in imperative markdown.
