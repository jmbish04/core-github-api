...
Analyze the user request and create a list of specific research questions and Google search queries.${await buildSkillContext(this.env as any, 'TopicOrchestratorAgent')}`,
