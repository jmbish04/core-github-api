  ...
  async scaffoldFromIssue(
    ...
    try {
      ...
      const schema = z.object({
        filePath: z.string().describe('The path of the primary new file to create.'),
        fileContent: z.string().describe('The entire code content for this new file.'),
        prTitle: z.string().describe('A concise pull request title.'),
        prDescription: z.string().describe('A markdown summary of what was implemented.'),
      });
