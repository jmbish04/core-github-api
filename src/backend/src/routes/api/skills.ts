...
import { getDb, agentSkills } from '@db';
import { eq } from 'drizzle-orm';
import { getOctokit } from '@/services/octokit/core';

// --- Zod Schemas ---
const SkillSchema = z.object({
  id: z.string().openapi({ description: 'UUID of the skill' }),
  name: z.string().openapi({ description: 'Name of the skill' }),
  description: z.string().openapi({ description: 'Description of the skill' }),
  markdownContent: z.string().openapi({ description: 'Raw markdown content' }),
  githubPath: z.string().nullable().openapi({ description: 'Original GitHub path if synced' }),
