...
export default function ChatPage() {
  ...
  return (
    <AssistantRuntimeProvider runtime={runtime as any}>
      <WeatherToolUI />
      <SidebarProvider className="min-h-0 h-[calc(100vh-6rem)] w-full flex-row relative bg-background border rounded-xl overflow-hidden shadow-sm">
        <div className="flex h-full w-full relative">
          ...
          <ThreadListSidebar className="!absolute !h-full" />
