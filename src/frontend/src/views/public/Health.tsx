    ...
    const fetchLatest = useCallback(async () => {
        try {
            ...
            if (res.ok) {
                ...
                const err = new Error(details || `Health service returned ${res.status}`);
    ...
    const fetchHistory = async () => {
        try {
            ...
            if (res.ok) {
                ...
                handleGlobalError(new Error(await res.text() || `Health history returned ${res.status}`));
            }
        } catch (e) {
    ...
    const analyzeFailure = async (result: HealthResult) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                handleGlobalError(new Error(errDetails || `Analysis failed with status ${res.status}`));
            }
        } catch (e) {
            handleGlobalError(e);
        } finally {
