      ...
      <div className="flex items-center group justify-between px-2 py-1 rounded-md hover:bg-accent/50">
        ...
        <div className="flex items-center opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
          <button 
            ...
            className="p-1 hover:bg-background rounded-sm focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-none"
          ...
          {!isFav && (
            <button 
              ...
              className="p-1 hover:bg-background rounded-sm text-muted-foreground hover:text-red-400 focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-none"
        ...
        <div>
          <button
            ...
            className={cn(
              ...
              "text-muted-foreground hover:text-foreground hover:bg-accent/60 focus-visible:ring-1 focus-visible:ring-ring focus-visible:outline-none"
            )}
          >
