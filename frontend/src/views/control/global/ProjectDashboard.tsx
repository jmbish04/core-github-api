...
export default function ProjectDashboard() {
  ...
  const activeTab = TAB_SLUG_MAP[rawTab] || "dashboard";
  ...
  const handleSyncSecrets = async (force = false) => {
    ...
    try {
        ...
        const data = await res.json() as { success: boolean; results?: any[]; error?: string };
      ...
      <Tabs value={activeTab} onValueChange={handleTabChange} className="space-y-4">
        ...
        <TabsContent value="dashboard" className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-6 xl:grid-cols-3">
            <Card className="xl:col-span-2 flex flex-col overflow-hidden h-[calc(100vh-12rem)] min-h-[500px]">
              <CardHeader>
