/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 2f065b9e1f9731801f8f7e54421ae6c9)
// Runtime types generated with workerd@1.20260617.1 2026-03-12 no_handle_cross_request_promise_resolution,nodejs_compat
interface __BaseEnv_Env {
	...
	CORE_GITHUB_API_GITHUB_APP_PRIVATE_KEY_PT1: SecretsStoreSecret;
	CORE_GITHUB_API_GITHUB_APP_PRIVATE_KEY_PT2: SecretsStoreSecret;
	CORE_GITHUB_API_GITHUB_APP_PRIVATE_KEY_PT3: SecretsStoreSecret;
	...
	RESEARCH_QUEUE_REPO_NAME: "core-github-research";
	RESEARCH_QUEUE_REPO_DISPATCHER_URI: "https://api.github.com/repos/jmbish04/core-github-research/dispatches";
	BASE_URL: "https://core-github-api.hacolby.workers.dev";
	WEBHOOK_URL: "https://core-github-api.hacolby.workers.dev/api/webhooks";
	MAX_AI_BUDGET: "50";
	...
	EDGRAPH_URL: "https://core-github-api-edgraph.hacolby.workers.dev";
	SANDBOX_SLEEP_AFTER: "30s";
	SANDBOX_INSTANCE_GET_TIMEOUT_MS: 180000;
	SANDBOX_PORT_READY_TIMEOUT_MS: 180000;
	SANDBOX_EXPOSED_HTTP_PORT: 8080;
	GITHUB_APP_PRIVATE_KEY: string;
	GITHUB_PERSONAL_ACCESS_TOKEN: string;
	JULES_PR_REVIEWER: DurableObjectNamespace /* JulesPrReviewer */;
	ORCHESTRATOR: DurableObjectNamespace /* OrchestratorAgent */;
	RetrofitAgent: DurableObjectNamespace /* RetrofitAgent */;
	ROOM_DO: DurableObjectNamespace /* RoomDO */;
	GEMINI_AGENT: DurableObjectNamespace /* GeminiAgent */;
	PLANNER: DurableObjectNamespace /* PlannerAgent */;
	REPO_AGENT: DurableObjectNamespace /* RepoAgent */;
	SUPERVISOR: DurableObjectNamespace /* Supervisor */;
	DEEP_REASONING_AGENT: DurableObjectNamespace /* DeepReasoningAgent */;
	SANDBOX: DurableObjectNamespace<import("./src/backend/src/index").Sandbox>;
	OWNER_AGENT: DurableObjectNamespace /* OwnerAgent */;
	RESEARCH_AGENT: DurableObjectNamespace /* ResearchAgent */;
	DISCORD_RESEARCH_AGENT: DurableObjectNamespace /* DiscordResearchAgent */;
	JULES_OVERSEER: DurableObjectNamespace /* JulesOverseer */;
	TOPIC_ORCHESTRATOR: DurableObjectNamespace /* TopicOrchestratorAgent */;
	WEB_SEARCH_AGENT: DurableObjectNamespace /* WebSearchAgent */;
	JUDGE_AGENT: DurableObjectNamespace /* JudgeAgent */;
	REPORTING_AGENT: DurableObjectNamespace /* ReportingAgent */;
	LANDING_PAGE_AGENT: DurableObjectNamespace /* LandingPageAgent */;
	CLOUDFLARE_DOCS_AGENT: DurableObjectNamespace /* CloudflareDocsAgent */;
	DEEP_RESEARCH_CHAT_AGENT: DurableObjectNamespace /* DeepResearchChatAgent */;
	HEALTH_DIAGNOSTICIAN: DurableObjectNamespace /* HealthDiagnostician */;
	JULES_WEBHOOK_BROADCASTER: DurableObjectNamespace /* JulesWebhookBroadcaster */;
	PLANNING_MONITOR: DurableObjectNamespace /* PlanningMonitor */;
	REVERSE_ENGINEERING_MONITOR: DurableObjectNamespace /* ReverseEngineeringMonitor */;
	PLANNING_SUPERVISOR: DurableObjectNamespace /* PlanningSupervisorAgent */;
	PLANNING_ORCHESTRATOR_AGENT: DurableObjectNamespace /* PlanningOrchestratorAgent */;
	HONI_ORCHESTRATOR: DurableObjectNamespace /* HoniOrchestrator */;
	HONI_CONSULTANT: DurableObjectNamespace /* HoniConsultant */;
	WORKSHOP_AGENT: DurableObjectNamespace /* WorkshopAgent */;
	AGENT_SESSION_DO: DurableObjectNamespace /* AgentSessionDO */;
	CF_WORKSHOP_AGENTS_SDK: DurableObjectNamespace /* CfWorkshop_AgentsSdk */;
	...
	LEARNING_AGENT: DurableObjectNamespace /* LearningAgent */;
	EDGRAPH: Fetcher /* core-github-api-edgraph */;
	CLAUDE_AGENT: Service /* entrypoint ClaudeAgentRPC from claude-agent-worker */;
	GITHUB_SEARCH_WORKFLOW: Workflow /* GithubSearchWorkflow */;
	DEEP_RESEARCH_WORKFLOW: Workflow /* DeepResearchWorkflow */;
	RESEARCH_ORCHESTRATOR: Workflow /* ResearchOrchestrator */;
	LEARNING_WORKFLOW: Workflow /* LearningWorkflow from core-github-api */;
	TOPIC_RESEARCH_WORKFLOW: Workflow /* TopicResearchWorkflow */;
	DISCORD_RESEARCH_WORKFLOW: Workflow /* DiscordResearchWorkflow */;
	PLANNING_ORCHESTRATOR: Workflow /* PlanningOrchestrator */;
	CLOUDFLARE_CHANGELOG_WORKFLOW: Workflow /* CloudflareChangelogWorkflow */;
	STITCH_LOOP_WORKFLOW: Workflow /* StitchLoopWorkflow */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/backend/src/index");
		durableNamespaces: "OrchestratorAgent" | "RetrofitAgent" | "RoomDO" | "GeminiAgent" | "PlannerAgent" | "RepoAgent" | "Supervisor" | "DeepReasoningAgent" | "Sandbox" | "OwnerAgent" | "ResearchAgent" | "DiscordResearchAgent" | "JulesOverseer" | "TopicOrchestratorAgent" | "WebSearchAgent" | "JudgeAgent" | "ReportingAgent" | "LandingPageAgent" | "CloudflareDocsAgent" | "DeepResearchChatAgent" | "HealthDiagnostician" | "JulesWebhookBroadcaster" | "PlanningMonitor" | "ReverseEngineeringMonitor" | "PlanningSupervisorAgent" | "PlanningOrchestratorAgent" | "HoniOrchestrator" | "HoniConsultant" | "WorkshopAgent" | "CfWorkshop_AgentsSdk" | "StandardizationAgent" | "JulesPrReviewer" | "UxResearcher" | "AgentSessionDO" | "SandboxAgent" | "PRSupervisorDO" | "PRReviewDO" | "PRSummaryDO" | "LearningAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOG_LEVEL" | "AI_DEFAULT_PROVIDER" | "AI_DEFAULT_MODEL" | "GEMINI_MODEL" | "OPENAI_MODEL" | "DEFAULT_MODEL_REASONING" | "DEFAULT_MODEL_STRUCTURED_RESPONSE" | "DEFAULT_MODEL_EMBEDDING" | "DEFAULT_MODEL_RERANKER" | "HEALTH_SANDBOX_TIMEOUT_MS" | "AI_GATEWAY_NAME" | "CLOUDFLARE_WORKER_NAME" | "GITHUB_OWNER" | "TEMPLATES_REPO_NAME" | "STANDARDIZATION_REPO_NAME" | "HEALTH_TEST_REPO_NAME" | "RESEARCH_QUEUE_REPO_NAME" | "RESEARCH_QUEUE_REPO_DISPATCHER_URI" | "BASE_URL" | "WEBHOOK_URL" | "MAX_AI_BUDGET" | "USE_OPENAI_MODELS" | "GITHUB_REPO_STANDARDIZATION" | "GITHUB_ACTION_WORKER_DISPATCHER_URI" | "MCP_API_URL" | "EDGRAPH_URL" | "SANDBOX_SLEEP_AFTER" | "SANDBOX_INSTANCE_GET_TIMEOUT_MS" | "SANDBOX_PORT_READY_TIMEOUT_MS" | "SANDBOX_EXPOSED_HTTP_PORT" | "GITHUB_APP_PRIVATE_KEY" | "GITHUB_PERSONAL_ACCESS_TOKEN">> {}
}
declare module "*.hbs" {
	const value: string;
