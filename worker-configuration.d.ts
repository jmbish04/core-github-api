/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3d735da0634a3027349259e459ded622)
// Runtime types generated with workerd@1.20250927.0 2024-09-23 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "OrchestratorAgent" | "RetrofitAgent" | "RoomDO" | "GeminiAgent" | "PlannerAgent" | "Supervisor" | "DeepReasoningAgent";
	}
	interface Env {
		ETAG_KV: KVNamespace;
		...
		RetrofitAgent: DurableObjectNamespace<import("./src/index").RetrofitAgent>;
		ROOM_DO: DurableObjectNamespace<import("./src/index").RoomDO>;
		GEMINI_AGENT: DurableObjectNamespace<import("./src/index").GeminiAgent>;
		PLANNER: DurableObjectNamespace /* PlannerAgent */;
		SUPERVISOR: DurableObjectNamespace<import("./src/index").Supervisor>;
		DEEP_REASONING_AGENT: DurableObjectNamespace<import("./src/index").DeepReasoningAgent>;
		DB: D1Database;
		DB_WEBHOOKS: D1Database;
		COLBY_OPS: Fetcher /* colby-ops-container */;
		AI: Ai;
		ASSETS: Fetcher;
		GITHUB_SEARCH_WORKFLOW: Workflow;
	}
}
