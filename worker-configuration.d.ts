/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a623798ce660ea8019d92f4fd91c889e)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "OrchestratorAgent" | "RetrofitAgent" | "RoomDO" | "GeminiAgent" | "PlannerAgent" | "DataProcessor" | "Supervisor" | "DeepReasoningAgent" | "RepoAgent" | "Sandbox" | "OwnerAgent" | "ResearchAgent" | "JulesOverseer" | "TopicOrchestratorAgent" | "WebSearchAgent" | "JudgeAgent" | "ReportingAgent";
	}
	interface Env {
		ETAG_KV: KVNamespace;
		...
		GEMINI_MODEL: "@cf/meta/llama-3.3-70b-instruct-fp8-fast";
		...
		COLBY_OPS: DurableObjectNamespace<import("./backend/src/index").DataProcessor>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "LOG_LEVEL" | "AI_DEFAULT_PROVIDER" | "AI_DEFAULT_MODEL" | "GEMINI_MODEL" | "AI_GATEWAY_NAME" | "GITHUB_OWNER" | "BASE_URL" | "MAX_AI_BUDGET" | "USE_OPENAI_MODELS">> {}
}
declare module "*.hbs" {
	const value: string;
