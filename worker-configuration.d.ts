/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 55fec90ad2c014ddad0ed7e14fb54251)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "OrchestratorAgent" | "RetrofitAgent" | "RoomDO" | "GeminiAgent" | "PlannerAgent" | "Supervisor" | "DeepReasoningAgent" | "RepoAgent" | "Sandbox" | "OwnerAgent" | "ResearchAgent" | "JulesOverseer" | "TopicOrchestratorAgent" | "WebSearchAgent" | "JudgeAgent" | "ReportingAgent" | "LandingPageAgent" | "CloudflareDocsAgent" | "HealthDiagnostician" | "DeepResearchChatAgent" | "WorkshopAgent" | "CfWorkshop_AgentsSdk" | "JulesWebhookBroadcaster" | "StandardizationAgent" | "DiscordResearchAgent" | "PlanningMonitor" | "PlanningSupervisorAgent" | "PlanningOrchestratorAgent" | "ReverseEngineeringMonitor" | "HoniOrchestrator" | "HoniConsultant" | "AgentSessionDO";
	}
	interface Env {
		ETAG_KV: KVNamespace;
		...
		PLANNER: DurableObjectNamespace<import("./backend/src/index").PlannerAgent>;
		REPO_AGENT: DurableObjectNamespace<import("./backend/src/index").RepoAgent>;
		SUPERVISOR: DurableObjectNamespace<import("./backend/src/index").Supervisor>;
		DEEP_REASONING_AGENT: DurableObjectNamespace<import("./backend/src/index").DeepReasoningAgent>;
		...
		DISCORD_RESEARCH_AGENT: DurableObjectNamespace<import("./backend/src/index").DiscordResearchAgent>;
		JULES_OVERSEER: DurableObjectNamespace<import("./backend/src/index").JulesOverseer>;
		TOPIC_ORCHESTRATOR: DurableObjectNamespace<import("./backend/src/index").TopicOrchestratorAgent>;
		WEB_SEARCH_AGENT: DurableObjectNamespace<import("./backend/src/index").WebSearchAgent>;
		JUDGE_AGENT: DurableObjectNamespace<import("./backend/src/index").JudgeAgent>;
		REPORTING_AGENT: DurableObjectNamespace<import("./backend/src/index").ReportingAgent>;
		LANDING_PAGE_AGENT: DurableObjectNamespace<import("./backend/src/index").LandingPageAgent>;
		CLOUDFLARE_DOCS_AGENT: DurableObjectNamespace<import("./backend/src/index").CloudflareDocsAgent>;
		DEEP_RESEARCH_CHAT_AGENT: DurableObjectNamespace<import("./backend/src/index").DeepResearchChatAgent>;
		HEALTH_DIAGNOSTICIAN: DurableObjectNamespace<import("./backend/src/index").HealthDiagnostician>;
		JULES_WEBHOOK_BROADCASTER: DurableObjectNamespace<import("./backend/src/index").JulesWebhookBroadcaster>;
		PLANNING_MONITOR: DurableObjectNamespace<import("./backend/src/index").PlanningMonitor>;
		REVERSE_ENGINEERING_MONITOR: DurableObjectNamespace<import("./backend/src/index").ReverseEngineeringMonitor>;
		PLANNING_SUPERVISOR: DurableObjectNamespace<import("./backend/src/index").PlanningSupervisorAgent>;
		PLANNING_ORCHESTRATOR_AGENT: DurableObjectNamespace<import("./backend/src/index").PlanningOrchestratorAgent>;
		HONI_ORCHESTRATOR: DurableObjectNamespace<import("./backend/src/index").HoniOrchestrator>;
		HONI_CONSULTANT: DurableObjectNamespace<import("./backend/src/index").HoniConsultant>;
		...
		STANDARDIZATION_AGENT: DurableObjectNamespace<import("./backend/src/index").StandardizationAgent>;
		AGENT_SESSION_DO: DurableObjectNamespace<import("./backend/src/index").AgentSessionDO>;
		...
		AI: Ai;
		ASSETS: Fetcher;
		GITHUB_SEARCH_WORKFLOW: Workflow<Parameters<import("./backend/src/index").GithubSearchWorkflow['run']>[0]['payload']>;
		DEEP_RESEARCH_WORKFLOW: Workflow<Parameters<import("./backend/src/index").DeepResearchWorkflow['run']>[0]['payload']>;
		RESEARCH_ORCHESTRATOR: Workflow<Parameters<import("./backend/src/index").ResearchOrchestrator['run']>[0]['payload']>;
		TOPIC_RESEARCH_WORKFLOW: Workflow<Parameters<import("./backend/src/index").TopicResearchWorkflow['run']>[0]['payload']>;
		DISCORD_RESEARCH_WORKFLOW: Workflow<Parameters<import("./backend/src/index").DiscordResearchWorkflow['run']>[0]['payload']>;
		PLANNING_ORCHESTRATOR: Workflow<Parameters<import("./backend/src/index").PlanningOrchestrator['run']>[0]['payload']>;
	}
}
