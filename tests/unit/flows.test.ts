...
describe('Flows API', () => {
  ...
  describe('Workflow Templates', () => {
    it('should have PR comment extractor workflow template', async () => {
      const { makeWorkflowTemplates } = await import('@/services/github/workflow-templates')
    ...
    it('should detect wrangler config files correctly', async () => {
      // Must use dynamic import to allow vi.mock to execute first in vitest node environment
      const { shouldIncludeCloudflareWorkflow } = await import('@/services/github/workflow-templates')
