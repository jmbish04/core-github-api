...
def main():
    ...
    for file_path in files:
        try:
            ...
            uses_db1 = 'env.DB' in content or 'c.env.DB' in content or 'getDb' in content or 'this.db' in content or 'db.select' in content or 'db.insert' in content or 'db.update' in content or 'db.delete' in content
