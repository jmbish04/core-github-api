...
def main():
    ...
    for file_path in files:
        try:
            ...
            uses_db1 = 'env.DB' in content or 'c.env.DB' in content or 'getDb(' in content or '.select(' in content or '.insert(' in content or '.update(' in content or '.delete(' in content
    ...
    ignored_slop = {
        'audit_logs', 'automation_runs', 'chat_tags',
        'code_review_comment_enrichments', 'code_review_comments',
        'code_review_runs', 'container_logs', 'events',
        'operation_logs', 'organization_settings', 'repo_ai_context',
        'repo_drafts', 'repo_infra', 'repo_tags', 'repo_tech_stack',
